...
import imgContainerFooter from '../../assets/img/container-footer.png';
  ...
  render() {
    return (
        <div className="row container__footer">
            <div className="col-1260 l-6 m-12 c-12 container__footer-content">
            <div className="container__footer-description">
                <svg
                version="1.1"
                viewBox="0 0 244 50"
                className="container__footer-description-img"
                >
                <path
                    pid={0}
                ...
                <h2 className="container__footer-description-heading">
                TÌM KIẾM CHỖ Ở GIÁ TỐT NHẤT
                </h2>
                <p className="container__footer-description-text">
            ...
            <div className="row container__footer-download">
                <div className="col l-6 m-0 c-0 container__footer-qrcode">
                <img
                    src={imgQRcode}
                    alt=""
                    className="container__footer-qr"
                />
                </div>
                <div className="col l-6 c-12 row container__footer-downloadapp">
                {/* <div class="row"> */}
            ...
            <img
            src={imgContainerFooter}
            alt=""
            className="col-1260 l-6 m-12 c-12 container__footer-img"
            />
      </div>
...
function ImageApp(props){
    return(
        <a
            href={props.link}
            className="col l-12 m-6 c-12 container__footer-downloadapp-link"
            >
            <img
            width="139px"
            height="43px"
            src={props.imagePath}
            alt=""
            className="container__footer-appstore"
            />
        </a>
