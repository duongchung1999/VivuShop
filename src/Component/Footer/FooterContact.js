...
export default class FooterContact extends Component {
  render() {
    return (
        <div className="col-1260 l-2-4 m-6 c-12">
            <svg
            version="1.1"
            viewBox="0 0 244 50"
            ...
            <div className="row footer__content-connect">
            <div className="col l-12 c-12">
                <div className="footer__content-connect-mess">
                <div className="footer__content-connect-mess-content">
                    <h6 className="footer__content-connect-mess-heading">Messenger</h6>
                    <a href="" className="footer__content-connect-mess-link">
                    http://m.me/luxstay
                    </a>
                </div>
                </div>
            ...
            <div className="col l-12 c-12">
                <div className="footer__content-connect-mess">
                <div className="footer__content-connect-mess-content">
                    <h6 className="footer__content-connect-mess-heading">Call center</h6>
                    <a
                    href="tell:18006586"
                    className="footer__content-connect-mess-phone"
                    >
                    18006586 (Việt Nam)
                    </a>
                    <a
                    href="tell:0889866666"
                    className="footer__content-connect-mess-phone"
                    >
                    0889866666
                    </a>
